    ...
    >
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-2 py-4 px-4 lg:mt-2 lg:px-6">
          ...
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Menu Item Overview --> */}
              {/* <!-- Menu Item Hotel --> */}
              {userInfo.role === "hotel" || userInfo.role === "admin" ? (
                <div>
                  <SidebarLinkGroup
                    activeCondition={
              ...
              {userInfo.role === "restaurant" || userInfo.role === "admin" ? (
                <SidebarLinkGroup
                  activeCondition={
                    pathname === "/restaurant" ||
		...
		C285.563,81.188,120.842,80.939,120.842,206.782z"
              ...
              {/* <!-- Menu Item Admin --> */}
              {/* <!-- Menu Item Kitchen --> */}
              {userInfo.role === "kitchen" || userInfo.role === "admin" ? (
                <SidebarLinkGroup
                  activeCondition={
              ...
              {/* <!-- Menu Item Kitchen --> */}
              {/* <!-- Menu Item Store --> */}
              {userInfo.role === "Store" || userInfo.role === "admin" ? (
                <SidebarLinkGroup
                  activeCondition={
                    pathname === "/forms" || pathname.includes("forms")
                  }
			...
			c4.717,0,8.533-3.817,8.533-8.533v-42.667C359.538,301.417,356.787,298.667,352.071,298.667z"
              ...
              {userInfo.role === "super" ? (
                <SidebarLinkGroup
                  activeCondition={
                    pathname === "/super" || pathname.includes("super")
                  }
                >
                  {(handleClick, open) => {
                    return (
