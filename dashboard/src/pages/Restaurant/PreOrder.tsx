          ...
          {showModal && (
            ...
            >
              ...
              <div id="invoice-POS" ref={componentRef}>
                <div id="mid">
                  <div className="mt-1">
                    <h3 className="text-center text-xs font-bold text-green-900 uppercase mb-2 bg-green-500/20 dark:bg-slate-300">
                      KOT
                    </h3>
                    {/* <center id="top">
                      <div className="info">
                ...
                <div id="bot">
                  <div id="table" className="text-xs">
                    <table
                    ...
                    >
                      <thead>
                        <tr className="tabletitle">
                          <td
                            className="item table-header"
                            style={{ padding: "5px", width: "80%" }}
                          >
                            Item
                          </td>
                          <td
                            className="Hours table-header"
