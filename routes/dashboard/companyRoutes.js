...
router.put("/company-update", authMiddleware, companyController.update_company);
router.get("/companies-get", companyController.get_company);
router.get(
  "/a-company-get/:companyId",
  authMiddleware,
  companyController.get_a_company
);
...
router.get(
  ...
  authMiddleware,
  companyController.get_company_branch
);
router.put(
  "/branch-status",
  authMiddleware,
  companyController.set_branch_status
);
router.get(
  "/a-branch-get/:branchId",
  authMiddleware,
  companyController.get_a_branch
);
